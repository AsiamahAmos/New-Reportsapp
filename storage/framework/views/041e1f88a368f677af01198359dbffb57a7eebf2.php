...
<script type="text/javascript" charset="utf-8">
   ...
   jQuery(document).ready(function ( $ ){
    jQuery(document).idleTimeout({
      redirectUrl: "<?php echo e(url('/logoutSession')); ?>",      // redirect to this url on logout. Set to "redirectUrl: false" to disable redirect
...
<!--end of the seesion time out code--><?php /**PATH C:\xampp\htdocs\reportsapp\resources\views/report/session-timeout.blade.php ENDPATH**/ ?>