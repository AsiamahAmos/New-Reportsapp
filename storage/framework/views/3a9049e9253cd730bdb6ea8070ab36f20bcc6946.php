...
// try{
$emailSettings = Controller::emailSettings();
$currentUserDetails  = Controller::currentUserDetails();
$sessionTimeOut = Controller::sessionTimeOut();

$homeController = new HomeController;
$optionBranches = $homeController->optionBranches();
$optionUsersNoAccess = $homeController->optionUsersNoAccess();

// } catch(Exception $e) {

//     return "Message: ".$e->getMessage().". Please contact system administrator for help";
    ...
    <body>
                    ...
                    <div class="container-fluid">
                        <div class="page-title-bo">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h5 class="page-title">Email Settings</h5>
                                </div>
        ...
        <div class="card">
            <div style="background:#30419b;color:white" class="card-header">
                <strong>Email Setup</strong> Settings
            </div>
            ...
            <form action="<?php echo e(url('/email-setup')); ?>" method="post" enctype="multipart/form-data" class="form-horizontal"><?php echo e(csrf_field()); ?>
                ...
                <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="username" class=" form-control-label">Email Driver</label>
                        </div>
                        <div class="col-9 col-md-6">
                              
                        <input readonly="readonly" value="<?php echo e($emailSettings->email_driver); ?>" type="text" id="driver" name="driver" placeholder="Enter driver" class="form-control">
                    ...
                    <div class="row form-group">
                        ...
                        <input value="<?php echo e($emailSettings->email_host); ?>" type="text" id="host" name="host" placeholder="Enter host" class="form-control">
                        <input type="hidden" name="email-id" value="<?php echo e($emailSettings->id); ?>"/>
                    ...
                    <div class="row form-group">
                        ...
                        <input value="<?php echo e($emailSettings->email_username); ?>" type="text" id="username" name="username" placeholder="Enter email username" class="form-control">
                    ...
                    <div class="row form-group">
                        ...
                        <input value="<?php echo e($emailSettings->email_password); ?>" type="password" id="password" name="password" placeholder="Enter email password" class="form-control">
                    ...
                    <div class="row form-group">
                        ...
                        <input value="<?php echo e($emailSettings->email_port); ?>" type="text" id="port" name="port" placeholder="Enter email port" class="form-control">
                    ...
                    <div class="row form-group">
                        ...
                        <input value="<?php echo e($emailSettings->email_encrytion); ?>" type="text" id="encryption" name="encryption" placeholder="Enter encryption method" class="form-control">
                
                            <small class="form-text text-muted">Please enter encryption method</small>
                        </div>
                    </div>

                    <button style="margin-left:45%" type="submit" class="btn btn-primary">Apply Changes</button>
...
<!--  Modal content for the above example add access -->
<div class="modal email-setup" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
       ...
       <div class="col-lg-12">
        <div class="card">
            ...
            <!-- end modal large email setup --><?php /**PATH C:\xampp\htdocs\reportsapp\resources\views/report/email-setup.blade.php ENDPATH**/ ?>