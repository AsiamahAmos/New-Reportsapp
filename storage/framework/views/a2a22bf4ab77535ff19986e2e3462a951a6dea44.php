                    ...
                    <div class="container-fluid">
                        <div class="page-title-bo">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h5 class="page-title">View PDF</h5>
                                    
                                      <h5><button onclick="javascript:window.history.back()" class="btn btn-primary"><i class="mdi mdi-arrow-left-drop-circle-outline"></i><span> Back </span></button></h5>
...
<embed style="border:solid 2px blue" src="<?php echo e($file_path); ?>" width="100%"  height="500px" />
<?php else: ?>
<div class="alert alert-error alert-block" style="background-color:#f2dfd0;">
<button type="button" class="close" data-dismiss="alert">×</button>	
...
// // The plugin function for adding a new filtering routine
    ...
    $.fn.dataTable.ext.search.push(
        function(Settings, Data, DataIndex){
            var dateStart = parseDateValue($("#start").val().trim());
            var dateEnd = parseDateValue($("#end").val().trim());
...
$(document).ready(function() {
    ...
    $('#min, #max, #document_name, #branch_name').keyup( function() {table.draw();} );
    $('#min, #max, #document_name, #branch_name').change( function() {table.draw();} );
    //date range search
...
</html><?php /**PATH C:\xampp\htdocs\reportsapp\resources\views/report/view-pdf.blade.php ENDPATH**/ ?>