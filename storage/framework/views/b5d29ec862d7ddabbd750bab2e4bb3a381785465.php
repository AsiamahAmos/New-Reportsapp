...
<head>
    ...
    <!--loading buttons css---->
    <link href="<?php echo e(asset('css/reports_css/button-loadda/ladda-themeless.min.css')); ?>" rel="stylesheet" type="text/css"/>
    <!---end of loading button css---->
     ...
     <header style="left:0px;opacity:0" class="header-desktop d-none d-lg-block">
            <div class="section__content section__content--p70">
              <div class="header3-wrap">
                <div class="logo">
                    <a href="#">
                    <img style="height:75px;width:400px" src="<?php echo e(asset('images/reports_image/icon/offline-logo-blue.png')); ?>" alt="" />
                     </a>
                   </div>
                </div>
            </div>
            ...
            <div style="width:100%" class="main-content col-md-12">
                <div style="width:100%" class="section__content section__content--p70">
                    ...
                    <div class="col-lg-6" style="margin-left:200px;"> 
                                <div style="opacity:0.9;border:blue solid 2px" class="card">
                                    <div style="color:#17a2b8;text-align:center" class="card-header"><h2 style="color:#17a2b8">Report Viewer</h2></div>
                                        ...
                                        <form action="<?php echo e(url('/login')); ?>" method="post" class=""><?php echo e(csrf_field()); ?>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-addon"><img style="height:20px;width:20px" src="<?php echo e(asset('images/reports_image/icon/user4.png')); ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <img style="height:20px;width:20px" src="<?php echo e(asset('images/reports_image/icon/password2.png')); ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-actions form-group">
                                                <!-- <button style="margin-left:40%" type="submit" class="btn btn-primary btn-sm">Let's Go</button> -->
                                                <section class="progress-demo">
                                                <button style="margin-left:40%" type="submit" class="ladda-button ladda-button-demo btn btn-primary"  data-style="zoom-in">Let's Go</button>
                                                </section>
                                            </div>
                                        </form>
                                    </div>
                    ...
                    <div id="endBlock"></div>
                        <div class="row">
                          <div class="col-md-12">
                              <div  class="copyright">
                                  <p style="color:white">Copyright © <?php date('Y');?>. All rights reserved. <a href="https://unionsg.com" style="color:white"> Union Systems Global</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- loading buttons:::its js but found in the css folder::::take note of that-->
<script src="<?php echo e(asset('css/reports_css/button-loadda/spin.js')); ?>"></script>
<script src="<?php echo e(asset('css/reports_css/button-loadda/ladda.js')); ?>"></script>
<script src="<?php echo e(asset('css/reports_css/button-loadda/pages/loading-btn.init.js')); ?>"></script>
<!---end of loading buttons--->
...
$("#container").attr("style","background-color:#eee;background-image:url('<?php echo e(url('images/reports_image/icon/windows10-style.png')); ?>');background-repeat:no-repeat;background-size: 100% 100%");
