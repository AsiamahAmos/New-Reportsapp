                    ...
                    <div class="container-fluid">
                        <div class="page-title-bo">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h5 class="page-title">Branches</h5>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="card m-b-30">
                                    ...
                                    <?php endif; ?> 
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 90%;margin-left:10%">
                                            <thead style="color:#30419b">
                                            <tr>
                                            <th width="">Branch Code&nbsp;</th>
                                            <th width="">Branch Description&nbsp;</th>
                                            ...
                                            <tbody>
                                            <?php $__currentLoopData = $branchDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <!-- <td>
                                            ...
                                            <td><?php echo e($branch->branch_code); ?>

                                            </td>
                                            <td>
                                                <?php echo e($branch->description); ?></span>
                                            </td>
                                            <td>
                                                <div class="table-data-feature">
                                                    
                                                    <button class="btn btn-primary" data-placement="top" title="Edit" data-toggle="modal" data-target=".editBranchModal-<?php echo e($branch->id); ?>">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </button>
                                                    <button id="deleteBranch" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Delete">
...
<div class="modal fade editBranchModal-<?php echo e($branch->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="myLargeModalLabel">Edit Branch</h5>
        ...
        <div class="card">
            <div style="background:#30419b;color:white" class="card-header">
                <strong>Edit This</strong> Branch
            </div>
            <div class="card-body card-block">
                <form action="<?php echo e(url('/edit-branch/'.$branch->id)); ?>" method="post" enctype="multipart/form-data" class="form-horizontal"><?php echo e(csrf_field()); ?>
                ...
                <div class="row form-group">
                        ...
                        <div class="col-9 col-md-6">
                            ...
                            <input required="required" type="text" id="branch-code" name="branch-code" placeholder="Enter Branch Code" class="form-control" value="<?php echo e($branch->branch_code); ?>">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-9 col-md-6">
                            ...
                            <input required="required" type="text" id="description" name="description" placeholder="Enter Description" class="form-control" value="<?php echo e($branch->description); ?>">
                            <small class="form-text text-muted">Please enter description</small>
                        </div>
                    </div>
            
                    <button style="margin-left:40%" type="submit" class="btn btn-primary">Update Branch</button>
            ...
            <div class="card-body card-block">
                ...
                <div class="row form-group">
                        ...
                        <div class="col-9 col-md-6">
                            ...
                            <input required="required" type="text" id="username" name="username" placeholder="Enter Username" class="form-control">
...
$("button#deleteBranch").click(function(){
//alert("grt");
var branch_id = $(this).find("input#branch_id").val();
//alert(branch_id);return false;
if(confirm("Do you really want to delete this branch")==true){

  window.location.href = "./delete-branch/"+branch_id;
...
$('td').css('padding','5px');
// $(".col-md-7").css("margin-right","1%");
// $("input[type=search]").css("margin-right","20%");
},100);
...
</html><?php /**PATH C:\xampp\htdocs\reportsapp\resources\views/report/view-branches.blade.php ENDPATH**/ ?>