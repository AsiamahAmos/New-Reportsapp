                                ...
                                <div class="card m-b-30">
                                    ...
                                    <?php endif; ?> 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                ///this nicely separates the user branches in the access table
                                                $currentAccess = explode('""',$access->branch_code);
                                                $currOption = "";  
                                                foreach($currentAccess as $currAccess){
                                                    if(!empty($currAccess)){
                                                $currOption .="<option data-mandatory='true' selected='selected' value='".$currAccess."'>".$currAccess."</option>"; 
                                                    }
                                                }
...
</html><?php /**PATH C:\xampp\htdocs\new-rep\reportsapp\resources\views/report/view-access.blade.php ENDPATH**/ ?>