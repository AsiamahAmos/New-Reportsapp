...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo e(url('images/reports_image/book.png')); ?>">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <!-- end page-title #36c5f0 #5e97fb #f0f4f7 #ddeeee -->
                      <div class="row">
                            <div class="col-12">
                 ...
                 <div class="card-body" style="background:#f0f4f7;border-radius:5px;border:2px solid #dee2e6">
                    <table border="0" cellspacing="5" cellpadding="5">
                            <tbody>
                            <tr>
                                <td style="color:black">Document&nbsp;Description:</td>
                                ...
                                <td style="color:#36c5f0;opacity:0">
                            ...
                            <tr>
                               <td style="color:black">Branch&nbsp;Name:</td>
                                ...
                                <td style="color:black">End&nbsp;Date:</td>
                                <td><input class="form-control form-control-md datepicke" style="width:100%" type="date" id="end" name="end" value="2040-04-21"></td>
                            </tr>
                            <!-- <tr>
                                <td colspan="9">
                                    <legend></legend>
...
<hr style="min-height:40px;background-color:#f9f9f9">
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap display" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
        ...
        foreach($doc_info as $key => $rep){
            ...
            foreach($filePaths as $path){///folder path
            //$file = explode('\\',$path);
            $table_path = str_replace("\\xampp\htdocs","",$rep['file_path']);
            $table_path = explode(':',$table_path);//remove the C:\ drive
...
<div class="modal fade accessListModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
       ...
       <div class="col-lg-12">
        ...
        $("#end").val(today);////set end date to current date.
...
$(document).ready(function() {
   ...
   // $(".topbar-left").attr('style','Background:#aaa;');
    ...
    //$("li.float-left button").css("background-color","#00093e");
    },100);
...
</html><?php /**PATH C:\xampp\htdocs\reportsapp\resources\views/report/offline-report.blade.php ENDPATH**/ ?>