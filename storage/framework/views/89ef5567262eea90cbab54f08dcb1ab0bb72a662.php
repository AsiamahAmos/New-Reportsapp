        ...
        <div class="card">
            ...
            <form action="<?php echo e(url('/email-setup')); ?>" method="post" enctype="multipart/form-data" class="form-horizontal"><?php echo e(csrf_field()); ?>
                ...
                <div class="row form-group">
                        ...
                        <input value="<?php echo e($emailSettings->email_driver); ?>" type="text" id="driver" name="driver" placeholder="Enter driver" class="form-control">
                    ...
                    <button style="margin-left:45%" type="submit" class="btn btn-primary">Setup Email</button>
    ...
    <div class="modal-dialog modal-md">
       ...
       <div class="col-lg-12">
        <div class="card">
            ...
            <!-- end modal large email setup --><?php /**PATH C:\xampp\htdocs\new-rep\reportsapp\resources\views/report/email-setup.blade.php ENDPATH**/ ?>