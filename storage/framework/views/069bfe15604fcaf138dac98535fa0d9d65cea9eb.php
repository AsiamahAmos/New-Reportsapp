            ...
            <div style="width:100%" class="main-content col-md-12">
                <div style="width:100%" class="section__content section__content--p70">
                    ...
                    <div class="col-lg-6" style="margin-left:200px;">
                                <div style="background-image:url('<?php echo e(url('images/reports_image/icon/.jpg')); ?>');opacity:0.99" class="card">
...
$("#container").attr("style","background-color:#eee;background-image:url('<?php echo e(url('images/reports_image/icon/banner.jpg')); ?>');background-repeat:no-repeat;background-size: 100% 100%");
...
<!-- end document-->
<?php /**PATH C:\xampp\htdocs\new-rep\reportsapp\resources\views/Offline_report/login.blade.php ENDPATH**/ ?>