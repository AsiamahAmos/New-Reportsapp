                    ...
                    <div class="account-item clearfix js-item-menu">
                        ...
                        <div class="account-dropdown js-dropdown">
                            ...
                            <div class="account-dropdown__body">
                                ...
                                <div class="account-dropdown__item">
                                    <a href="<?php echo e(url('/user-settings/'.$user->id)); ?>">
        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="<?php echo e(url('/edit-user/'.$user->id)); ?>" method="post" enctype="multipart/form-data" class="form-horizontal"><?php echo e(csrf_field()); ?>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="other-name" class=" form-control-label">Idle Session Time</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="text" id="other-name" name="other-name" placeholder="Enter Other Names" class="form-control" value="<?php echo e($user->session_timeout); ?>">
                            <small class="form-text text-muted">Please enter the timeout</small>
                        </div>
                    </div>
                    <!-- <div class="row form-group">
                        <div class="col col-md-3">
...
<!-- end document-->
<?php /**PATH C:\xampp\htdocs\reportsapp\resources\views/offline_report/settings.blade.php ENDPATH**/ ?>